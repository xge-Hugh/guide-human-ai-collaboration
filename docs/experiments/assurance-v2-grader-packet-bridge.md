...
统一 harness 的 [`grading.py`](../../tools/assurance_eval/grading.py) 与 [`artifacts.py`](../../tools/assurance_eval/artifacts.py) 承担 packet、严格解析和本地证据边界；历史 bridge fixture 保留用于语义回归检查。
