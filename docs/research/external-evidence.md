...
这些资料主要用于校准以下问题：认知卸载与自动化偏差、认知负荷与脚手架、能力/迁移证据、压力与时间管理、表示与多媒体、共同理解与修复、复盘、游戏化与进度指标等。

引用研究时应保留其样本、任务、媒介和方法边界。研究可以支持背景风险、机制假设或设计启发，但不能自动证明本项目某个具体话术、阈值、阶段或载体是唯一正确实现。
...
本索引由旧 `docs/norm/05-antipatterns-and-boundaries.md` 的“科学表述边界 / 精简参考资料”迁出。旧章节原貌保存在 `docs/archive/norm-05-antipatterns-and-boundaries-v0.16.md`。
